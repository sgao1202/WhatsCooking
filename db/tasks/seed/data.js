module.exports = [
        ...
        recipes: [
            {
                ...
                ingredients: [
                    {
                        name: 'teaspoons olive oil (or canola oil)',
                        portion: 2,
                        units: 'teaspoons'
                    },
                    {
                        name: 'boneless, skinless chicken breasts, cut into small cubes (about 1/2 inch)',
                        portion: 1.5,
                        units: 'pounds'
                    },
                    {
    ...
    },
    {
        ...
        recipes: [
            {
                ...
                ingredients: [
                    {
                        name: 'chicken breasts (pounded 1/2-inch thin)',
                        portion: 4,
                        units: 'breasts'
                    },
                    {
                        name: 'onion powder and garlic powder',
                        portion: 2,
                        units: 'teaspoons'
                    },
                    {
                    ...
                    {
                        name: 'dried thyme and dried rosemary',
                        portion: 0.5,
                        units: 'teaspoon'
                    },
                    {
        ...
        comments: [
            {
                comment: 'this is an easy recipe'
            }
        ]
    },
    {
        ...
        recipes: [
            {
                ...
                ingredients: [
                    {
                        name: 'Cooked pasta of your choice, pasta water reserved',
                        portion: 1,
                        units: 'lb'
                    },
                    {
                    ...
                    {
                        name: 'Basil leaves, lightly packed',
                        portion: 2,
                        units: 'cups'
                    },
                    {
